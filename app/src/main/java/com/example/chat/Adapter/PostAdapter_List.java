...
public class PostAdapter_List extends RecyclerView.Adapter<PostAdapter_List.ViewHolder>  {
    ...
    public PostAdapter_List(Context mcontext, List<Post> mPost){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view= LayoutInflater.from(mcontext).inflate(R.layout.image_post,parent,false);
        return new PostAdapter_List.ViewHolder(view);
    }
       ...
       // holder.setIsRecyclable(false);
        ...
        holder.lit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tag==R.drawable.gray_lit_icon){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists()){
                    ...
                    if (isliked.getIsliked() == true) {
                        ...
                        lit.setImageResource(R.drawable.gray_lit_icon);
                        lit.setTag(R.drawable.gray_lit_icon);
